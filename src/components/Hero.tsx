    ...
    <>
      ...
      <div className="relative h-[calc(100vh-4rem)]">
        ...
        <div className="relative z-10 flex items-center justify-center h-full flex-wrap p-5">
          <div className="w-[50%]">
            <h2 className="text-2xl lg:text-4xl font-medium text-orange-400 py-2">
              Explore,Share,Enjoy Classic & Animated Recipe
            </h2>
            ...
            <Link href="/view">
              <Button className="bg-orange-400 w-40 hover:bg-orange-500">
                View Recipes
              </Button>
            </Link>
          </div>
